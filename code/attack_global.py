...
def Attack_Global(classifier, device, respace, t, eps=16, iter=10, name='attack_global', alpha=2, version='v1', skip=1):
    ...
    for i in tqdm(range(dataset.__len__())):
        ...
        si(torch.cat([ pred_x0], -1), save_path + f'{i}.png')
...
# model_list = ['alexnet', 'vgg19', 'densenet161', 'wideresnet', 'squeezenet', 'mobilenetv2']
#
# for model_name in model_list:
#     print(f'Testing {model_name}...')
#     Attack_Global(model_name, 0, 'ddim50', t=3, eps=16, iter=10, name=f'attack_global_{model_name}', alpha=2, version='v2')


Attack_Global('alexnet', 0, 'ddim50', t=3, eps=16, iter=10, name='attack_global_gradpass', alpha=2, version='v2')
